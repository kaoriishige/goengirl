...
const PORTAL_I18N = {
  ja: {
    ...
    portalPlanFreeF1: "推し色デジタル会員証の発行",
    portalPlanFreeF2: "現地GPSパネルチェックイン (初回100pt)",
    portalPlanFreeF3: "ポイント台帳での履歴・残高管理",
    portalPlanFreeF4: "ポイント特典交換 (限定ボイス・壁紙)",
    portalPlanFreeF5: "ご縁巡礼デジタルスタンプ帳",
    portalPlanFreeF6: "旅の写真投稿コミュニティ",
    portalPlanFreeF7: "新規入会特典 100pt 付与",
    ...
    portalPlanSupporterF1: "無料会員のすべての機能",
    portalPlanSupporterF2: "対象グッズの現地お取り置き・受取予約",
    portalPlanSupporterF3: "毎月限定の推しガール撮り下ろしボイス",
    portalPlanSupporterF4: "会員限定特製高画質スマートフォン壁紙",
    portalPlanSupporterF5: "提携店舗での会員限定プチ特典",
    portalPlanSupporterF6: "月額480円（いつでも解約可能）",
    ...
    portalPlanCocreateF1: "応援会員のすべての特典",
    portalPlanCocreateF2: "新企画・公式グッズ化のファン投票権",
    portalPlanCocreateF3: "四半期ごとのオンライン企画交流会参加権",
    portalPlanCocreateF4: "開発裏話・キャラクター制作秘話レポート",
    portalPlanCocreateF5: "限定プレミアム称号の付与",
    portalPlanCocreateF6: "月額980円（いつでも解約可能）",
  ...
  en: {
    ...
    portalPlanFreeF1: "Digital Member Pass issuance with favorite colors",
    portalPlanFreeF2: "On-site GPS Check-in (100pt initial bonus)",
    portalPlanFreeF3: "Points ledger history & balance management",
    portalPlanFreeF4: "Points redemption (Exclusive voices & wallpapers)",
    portalPlanFreeF5: "Sacred pilgrimage digital stamp book",
    portalPlanFreeF6: "Photo-sharing travel community",
    portalPlanFreeF7: "Welcome bonus: 100pt included immediately",
    ...
    portalPlanSupporterF1: "All Free Member features included",
    portalPlanSupporterF2: "On-site reservation & hold for exclusive merchandise",
    portalPlanSupporterF3: "Monthly newly recorded voice clips of your idol",
    portalPlanSupporterF4: "High-resolution exclusive smartphone wallpapers",
    portalPlanSupporterF5: "Special member perks at partner stores",
    portalPlanSupporterF6: "¥480 / month (Cancel anytime)",
    ...
    portalPlanCocreateF1: "All Supporter Plan perks included",
    portalPlanCocreateF2: "Voting rights on new goods & regional projects",
    portalPlanCocreateF3: "Quarterly online creator meetups",
    portalPlanCocreateF4: "Behind-the-scenes character development reports",
    portalPlanCocreateF5: "Exclusive premium title & badges",
    portalPlanCocreateF6: "¥980 / month (Cancel anytime)",
